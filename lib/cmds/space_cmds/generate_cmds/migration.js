...
module.exports.ctNameNeedsEscaping = function(ctId) {
  const reservedWords = [
    'break',
    'case',
    'catch',
...
module.exports.ctVariableEscape = function(ctId) {
  const camelCased = camelCase(ctId);
  return ctNameNeedsEscaping(camelCased) ? `_${camelCased}` : camelCased;
};

module.exports.wrapMigrationWithBase = function(blockStatement) {
...
module.exports.createContentType = function(ct) {
  const id = ct.sys.id;
...
module.exports.createField = function(ctId, field) {
...
module.exports.changeEditorInterface = function(
  ctId,
  fieldId,
  widgetId,
  settings
...
module.exports.getContentTypes = async function(environment, contentTypeId) {
  return contentTypeId
    ? [await environment.getContentType(contentTypeId)]
    : (await environment.getContentTypes()).items;
};

module.exports.generateContentTypeMigration = async function(
  environment,
  contentType
) {
...
module.exports.generateMigrationScript = async function(
  environment,
  contentTypes
) {
...
module.exports.generateFileName = function(
  spaceId,
  environmentId,
  contentTypeId
) {
