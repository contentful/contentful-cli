...
import { maybePublishContentType } from '../../core/patch/make-patch-hooks'
...
export async function publishPatchResults (patchResults, maybePublishContentType, helpers, logging, skipConfirm) {
  ...
  if (skipConfirm) {
    ...
    confirmed = await helpers.confirm('Your patches have been applied as drafts. Would you like to publish them now?')
  }
