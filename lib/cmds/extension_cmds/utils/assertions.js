...
export async function assertRequiredCreateValuesProvided ({ extension }) {
  await assertHasRequiredProperties(extension, ['name', 'fieldTypes'])
  await assertHasOneProperty(extension, ['src', 'srcdoc'])
}

export async function assertRequiredUpdateValuesProvided (data) {
