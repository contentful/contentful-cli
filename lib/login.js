...
export default async function login () {
  ...
  console.log('Welcome to the Contentful CLI tool')
  console.log()

  if (context.cmaToken) {
    console.log('Looks like you already stored a CMA token in your .contentfulrc file:')
    console.log(`Your token: '${context.cmaToken}'`)
  ...
  opn(oAuthURL)
  console.log('Awesome! I will store this information on your local machine so you can skip logging in in the future.')
  ...
  console.log(`Great! Let's store your CMA token on your local machine (${getConfigPath()})`)
  await setContext({
