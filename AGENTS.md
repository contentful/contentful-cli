...
| Sensitive files & guidance | [CONTRIBUTING.md — File-Level Guidance](./CONTRIBUTING.md#file-level-guidance) |
| Operational knowledge | [ARCHITECTURE.md — Operational Knowledge](./ARCHITECTURE.md#operational-knowledge) |
| Domain concepts | [ARCHITECTURE.md — Domain Concepts](./ARCHITECTURE.md#domain-concepts) |
