const { logout } = require('../../../lib/cmds/logout.js')
const { storeRuntimeConfig, setContext } = require('../../../lib/context.js')
const { assertLoggedIn } = require('../../../lib/utils/assertions.js')
const { confirmation } = require('../../../lib/utils/actions.js')
const { log, warning, success } = require('../../../lib/utils/log.js')

jest.mock('../../../lib/context.js')
jest.mock('../../../lib/utils/actions.js')
jest.mock('../../../lib/utils/log.js')
jest.mock('../../../lib/utils/assertions.js')
